...
class EnhancedWebSocketService {
    ...
    setupSocketEventHandlers(socket) {
        ...
        socket.on('get:execution:status', async (executionId, callback) => {
            try {
        ...
        socket.on('get:runner:status', async (runnerId, callback) => {
            try {
        ...
        // Control handlers
        socket.on('cancel:execution', async (executionId, callback) => {
            try {
        ...
        socket.on('pause:runner', async (runnerId, callback) => {
            try {
        ...
        socket.on('resume:runner', async (runnerId, callback) => {
            try {
    ...
    // Broadcast methods
    broadcastExecutionUpdate(update) {
    ...
    broadcastSystemAlert(level, message) {
