...
test_1.test.describe('Navigation Debug Test', () => {
    (0, test_1.test)('should navigate to test management page', async ({ page }) => {
        ...
        await (0, test_1.expect)(testsLink).toBeVisible();
...
//# sourceMappingURL=navigation-debug.spec.js.map